...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "KHAN-MD~SvgTgLCa#JyFwlCud_mnW8ERhDIqx27xavH8QC9atGAjs3LkEc8Q",
// add your Session Id 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*salut cmt ça va ?*",
// set the auto reply massage on status reply  
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "KHAN-MD",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "♨️𝚳𝚪 𝚯𝚰𝚳 𝐋𝐃𝐘 🆒😎ᴱˡ ˢᵘʳᵛⁱᵛᵒʳ",
...
DEV: process.env.DEV || "2250500161896",
